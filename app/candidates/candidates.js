...
function readProductsTemplate(data, keywords){
    ...
    var read_products_html=`
        ...
        <div class='input-group pull-left w-30-pct'>
            ...
            <input type='text' value='` + keywords + `' name='keywords' class='form-control product-search-keywords' placeholder='Search Candidates...' />
    ...
    $.each(data.records, function(key, val) {
        ...
        read_products_html+=`<tr>
            ...
            <td>
                ...
                <!-- edit button -->
                <button class='btn btn-info m-r-10px update-photo-button' data-id='` + val.id + `'>
                    <span class='glyphicon glyphicon-edit'></span> Update Photo
                </button>
